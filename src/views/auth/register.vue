<template>
    <form @submit.prevent="newUser">
        <div class="form-layer">
            <label>نام</label>
            <input type="text" placeholder="نام" v-model="isValidUser.name" required>
        </div>

        <div class="form-layer">
            <label>نام خانوادگی</label>
            <input type="test" v-model="isValidUser.lastname" placeholder="نام خانوادگی">
        </div>
        ...
        <div class="form-layer">
            <label>ایمیل</label>
            <input type="email" v-model="isValidUser.email" placeholder="ایمیل" required>
        </div>

        <div class="form-layer">
            <label>پسوورد</label>
            <input type="password" v-model="isValidUser.password1" placeholder="پسوورد" required>
        </div>

        <div class="form-layer">
            <label>تکرار پسوورد</label>
            <input type="password" v-model="isValidUser.password2" placeholder="تکرار پسوورد" required>
        </div>
